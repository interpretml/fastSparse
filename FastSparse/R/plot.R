...
#' @param x The output of FastSparse.fit
...
#' @method plot FastSparse
#' @export
plot.FastSparse <- function(x, gamma=0, showLines=FALSE, ...)
{
...
#' @param x The output of FastSparse.cvfit
#' @inheritParams plot.FastSparse
#' @examples
#' # Generate synthetic data for this example
#' data <- GenSynthetic(n=500,p=1000,k=10,seed=1)
#' X = data$X
...
#' fit <- FastSparse.cvfit(X, y, nFolds=5, seed=1, penalty="L0L2",
...
#'
#' @method plot FastSparseCV
#' @export
plot.FastSparseCV <- function(x, gamma=0, ...)
{
