...
#'
#' @export
coef.FastSparse <- function(object,lambda=NULL,gamma=NULL, ...){
...
#' @rdname coef.FastSparse
#' @method coef FastSparseCV
#' @export
coef.FastSparseCV <- function(object,lambda=NULL,gamma=NULL, ...){
    coef.FastSparse(object$fit,lambda,gamma, ...)
}
